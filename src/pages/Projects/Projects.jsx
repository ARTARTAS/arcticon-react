...
const state = {
  projects: [
    ...
    },
    {
        ...
        list: [
            "Поставка вентиляционных вытяжек"
        ]
    },
    {
        name: "ООО «Термокапитал»",
        list: [
            "Поставка силовой кабельно-проводниковой продукции"
        ]
    },
    {
    ...
    },
    {
        ...
        list: [
            "Поставка поршневых помп"
        ]
    },
    {
        name: "ФГУП «Главное военно-строительное управление №14»",
        list: [
            "Поставка высоковольтных опор для линии электропередач"
        ]
    },
    {
        name: "Федеральное агентство железнодорожного транспорта",
        list: [
            "Поставка водогрейного оборудования"
        ]
    },
    {
        name: "Прокуратура Московской области",
        list: [
            "Поставка телемеханических установок"
        ]
    },
    {
    ...
    },
    {
        ...
        list: [
            "Поставка модуля очистки"
        ]
    },
    {
        name: "ООО «Энергосервис»",
        list: [
            "Поставка монтажных проводов"
        ]
    },
    {
        name: "ПАО 'Криогенмаш'",
    ...
    <ProjectsStyles>
      <div class="container">
        <div class="block">
          ...
          <div class="block__orders">
            <h2>Заказчики</h2>
            <div class="block__orders_grid">
              <a href="#" class="order">
              ...
              <a href="#" class="order">
                Филиал ОАО «Белэлектромонтажналадка» в г. Москве
              </a>
              <a href="#" class="order">
                АО «Роспан Интернешнл»
              </a>
              <a href="#" class="order">
                Филиал СУ № 111 ФГУП «ГУССТ №1 при Спецстрое России»
              </a>
              <a href="#" class="order">
              ...
              <a href="#" class="order">
                ООО «ГК ЭФЭСК» Московский филиал
              </a>
              <a href="#" class="order">
                АО «СибурТюменьГаз»
              </a>
